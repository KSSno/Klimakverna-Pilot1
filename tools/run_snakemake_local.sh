...
# snakemake -n --snakefile /lustre/storeC-ext/users/klimakverna/development/Klimakverna-Pilot1/workflow/Snakefile --configfile /lustre/storeC-ext/users/klimakverna/development/Klimakverna-Pilot1/config/testing_config.yaml
