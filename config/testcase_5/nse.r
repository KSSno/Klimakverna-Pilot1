...
gauge2 <- c("00020268","00120178","00120070","00120193","00020323","00120171","00020279","00160140","00020634","00120215")
gauge3 <- c("66","87","5","53","43","62","32","34","33","109")  # objectID in arcGIS

for (i in 1:length(gauge)) {        

obs_file <-  paste("/lustre/storeC-ext/users/klimakverna/development/NVE/hydro/Obs_Q/",gauge[i],".0.1001.1",sep="")

if(file.exists(obs_file)==F) obs_file <-  paste("/lustre/storeC-ext/users/klimakverna/development/NVE/hydro/Obs_Q/",gauge[i],".0.1001.0",sep="")
                  
if(file.exists(obs_file)==F) obs_file <-  paste("/lustre/storeC-ext/users/klimakverna/development/NVE/hydro/Obs_Q/",gauge[i],".0.1001.2",sep="")
